...
import { Heading2Centered, Heading2CenteredColor } from '../StyledHeadings'
import { CityTableHeader } from '../CityDetail/StyledCitiesAndNeighbourhoods'
...
const FlatFilter = ({ setPageLimitCallback, callback, pageLimit, flatCount, cityName }: Props) => {
  ...
  const handleFilterClick = () => {
    ...
    setCurrentlyFilteredLimitPeriod(activeLimitPeriod)
